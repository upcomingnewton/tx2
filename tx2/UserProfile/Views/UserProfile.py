...
def StudentDetailsIndex(HttpRequest):
    ...
    return render_to_response("UserProfile/StudentDetails.html",{'LoggedUser':logindetails["fname"],'StudDetailStatus':StudDetailStatus,'BranchList':Branch.objects.all(),'CategoryList':Category.objects.all(),'DegreeList':Degree.objects.all()},context_instance=RequestContext(HttpRequest))
