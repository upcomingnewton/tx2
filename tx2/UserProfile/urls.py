...
urlpatterns = patterns('',
                       ...
                       #Marks
                       url(r'^Marks/Marks/save/post$','UserProfile.Views.Marks.MarksPostSave'),
                       url(r'^Marks/Marks/save$','UserProfile.Views.Marks.MarksSave'),
                      ...
                      #StudentDetails
                       ...
                       url(r'^UserProfile/StudentDetailsUpdate/$','UserProfile.Views.UserProfile.StudentDetailsUpdateIndex'),
                      #ExtraAcdemicInfo
